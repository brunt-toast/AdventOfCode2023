    ...
    */
    internal class Day5
    {
        ...
        public Day5()
        {
            ...
            _seedToSoilMap = ExtractMapItems(3, 37);
            _soilToFertilizerMap = ExtractMapItems(40, 72);
            _fertilizerToWaterMap = ExtractMapItems(75, 102);
            _waterToLightMap = ExtractMapItems(105, 119);
